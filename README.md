...
El objetivo es construir un sitio multipágina con diferentes secciones (Inicio, Destino, Tripulación y Tecnología), y adaptando el diseño y contenido a cada una. Dentro de cada sección hay unas pestañas internas que permiten practicar la navegación sin recargar la página.
